...
var import_server40 = require("next/server");
...
var FirebaseService = {
  ...
  async saveRecord(collectionName, id, data) {
    ...
    try {
      ...
      const verifiedSnap = await (0, import_firestore2.getDoc)(docRef);
...
async function resolveRelations(modelName, items, include) {
  ...
  for (const relationName of Object.keys(include)) {
    ...
    if (relationName === "process") {
      ...
      try {
        ...
        for (const f of countFields) {
          ...
          try {
            const snap = await (0, import_firestore3.getDocs)((0, import_firestore3.collection)(firestore, col));
    ...
    try {
      ...
      const targetSnapshot = await (0, import_firestore3.getDocs)(q);
...
async function GET() {
  ...
  return import_server.NextResponse.json(agentsWithStats);
}
async function POST(req) {
  ...
  return import_server.NextResponse.json(agent, { status: 201 });
}
...
async function POST2(req) {
  ...
  if (!agentId || !task) {
    return import_server2.NextResponse.json({ error: "agentId e task s\xE3o obrigat\xF3rios" }, { status: 400 });
  }
  const agent = await db.agent.findUnique({ where: { id: agentId } });
  if (!agent) {
    return import_server2.NextResponse.json({ error: "Agente n\xE3o encontrado" }, { status: 404 });
  }
  if (agent.status !== "Ativo") {
    return import_server2.NextResponse.json({ error: `Agente ${agent.status}` }, { status: 400 });
  }
...
async function GET2(req) {
  ...
  return import_server2.NextResponse.json(runs);
}
...
async function POST4(req) {
  ...
  if (!texto) {
    return import_server4.NextResponse.json({ error: "Texto \xE9 obrigat\xF3rio" }, { status: 400 });
  }
...
async function GET3(req) {
  ...
  return import_server5.NextResponse.json(resultado);
}
...
async function GET4(req) {
  ...
  return import_server6.NextResponse.json(articles);
}
async function POST5(req) {
  ...
  return import_server6.NextResponse.json(article, { status: 201 });
}
async function PUT(req) {
  const body = await req.json();
  const { articleId } = body;
  const article = await db.knowledgeArticle.findUnique({ where: { id: articleId } });
  if (!article) return import_server6.NextResponse.json({ error: "Artigo n\xE3o encontrado" }, { status: 404 });
  try {
...
${article.content}`
    ...
    return import_server6.NextResponse.json({ ...updated, summary });
  } catch (error) {
    return import_server6.NextResponse.json({ error: error.message }, { status: 500 });
  }
}
...
async function GET5() {
  ...
  return import_server7.NextResponse.json(standards);
}
async function POST6(req) {
  ...
  return import_server7.NextResponse.json(std, { status: 201 });
}
...
async function GET6(_req, { params }) {
  ...
  if (!proc) return import_server8.NextResponse.json({ error: "Processo n\xE3o encontrado" }, { status: 404 });
  const timeline = [];
  ...
  return import_server8.NextResponse.json({ ...proc, timeline });
}
async function PATCH(req, { params }) {
  ...
  return import_server8.NextResponse.json(proc);
}
...
async function POST7(req, { params }) {
  ...
  if (!proc) {
    return import_server9.NextResponse.json({ error: "Processo n\xE3o encontrado" }, { status: 404 });
  }
  if (!body.description || !body.description.trim()) {
    return import_server9.NextResponse.json({ error: "Descri\xE7\xE3o \xE9 obrigat\xF3ria" }, { status: 400 });
  }
  ...
  return import_server9.NextResponse.json(mov, { status: 201 });
}
...
async function GET7(req) {
  ...
  return import_server10.NextResponse.json(processes);
}
async function POST8(req) {
  ...
  return import_server10.NextResponse.json(proc, { status: 201 });
}
...
async function GET8() {
  ...
  return import_server11.NextResponse.json(items);
}
async function POST9(req) {
  ...
  return import_server11.NextResponse.json(item, { status: 201 });
}
...
async function POST10(req) {
  ...
  return import_server12.NextResponse.json({ ...auto, actions: JSON.parse(auto.actions) }, { status: 201 });
}
async function PATCH2(req) {
  const { searchParams } = new URL(req.url);
  const id = searchParams.get("id");
  if (!id) return import_server12.NextResponse.json({ error: "id required" }, { status: 400 });
  const body = await req.json();
  const allowedFields = {};
  ...
  return import_server12.NextResponse.json({ ...updated, actions: JSON.parse(updated.actions) });
}
async function PUT2(req) {
  ...
  if (!auto) return import_server12.NextResponse.json({ error: "n\xE3o encontrada" }, { status: 404 });
...
async function POST11(req) {
  ...
  if (!pergunta) {
    return import_server13.NextResponse.json({ error: "Pergunta \xE9 obrigat\xF3ria" }, { status: 400 });
  }
  const hoje = /* @__PURE__ */ new Date();
...
async function GET10(req) {
  ...
  if (!q || q.length < 2) {
    return import_server14.NextResponse.json({ results: [] });
  }
  ...
  return import_server14.NextResponse.json({ results, total: results.length });
}
...
async function PATCH3(req) {
  ...
  if (all === "true") {
    ...
    return import_server15.NextResponse.json({ ok: true, updated: "all" });
  }
  if (!id) return import_server15.NextResponse.json({ error: "id required" }, { status: 400 });
  const updated = await db.notification.update({
    where: { id },
    data: { read: true }
  });
  return import_server15.NextResponse.json(updated);
}
async function POST12(req) {
  ...
  return import_server15.NextResponse.json(n, { status: 201 });
}
...
async function GET12(req) {
  ...
  return import_server16.NextResponse.json({ eventos, inicio: inicioDate, fim: fimDate });
}
...
async function GET13(req) {
  ...
  return import_server17.NextResponse.json(clients);
}
async function POST13(req) {
  ...
  return import_server17.NextResponse.json(client, { status: 201 });
}
...
async function GET14(req) {
  ...
  return import_server18.NextResponse.json({
    rules: rules.map((r) => ({
      ...r,
...
async function POST14(req) {
  ...
  return import_server18.NextResponse.json(rule, { status: 201 });
}
async function PUT3(req) {
  const body = await req.json();
  const { entityType, entityId, entityName, content, type } = body;
  if (!content || !entityType) {
    return import_server18.NextResponse.json({ error: "entityType e content s\xE3o obrigat\xF3rios" }, { status: 400 });
  }
...
async function GET15(req) {
  ...
  return import_server19.NextResponse.json(tasks);
}
async function POST15(req) {
  ...
  return import_server19.NextResponse.json(task, { status: 201 });
}
async function PATCH4(req) {
  const { searchParams } = new URL(req.url);
  const id = searchParams.get("id");
  if (!id) return import_server19.NextResponse.json({ error: "id required" }, { status: 400 });
  const body = await req.json();
  ...
  return import_server19.NextResponse.json(updated);
}
async function DELETE(req) {
  ...
  return import_server19.NextResponse.json({ ok: true });
}
...
async function POST16(req) {
  ...
  return import_server21.NextResponse.json(tpl, { status: 201 });
}
...
async function GET18() {
  try {
    ...
    return import_server22.NextResponse.json({ success: true, message: "Firestore seeded successfully!" });
  } catch (error) {
    console.error("Error seeding Firestore:", error);
    return import_server22.NextResponse.json({ success: false, error: error.message }, { status: 500 });
  }
}
...
async function GET20(req) {
  ...
  if (!token) {
    return import_server24.NextResponse.json({ error: "Token necess\xE1rio" }, { status: 401 });
  }
...
async function GET21(req) {
  ...
  return import_server25.NextResponse.json(contracts);
}
async function POST17(req) {
  ...
  return import_server25.NextResponse.json(contract, { status: 201 });
}
async function PATCH5(req) {
  const { searchParams } = new URL(req.url);
  const id = searchParams.get("id");
  if (!id) return import_server25.NextResponse.json({ error: "id required" }, { status: 400 });
  const body = await req.json();
  if (body.acao === "assinar") {
    ...
    return import_server25.NextResponse.json(contract);
  }
  const updated = await db.contract.update({
    where: { id },
    data: { ...body, acao: void 0, assinantes: void 0 }
  });
  return import_server25.NextResponse.json(updated);
}
...
async function GET22(req) {
  ...
  return import_server26.NextResponse.json(items);
}
async function POST18(req) {
  ...
  return import_server26.NextResponse.json(fin, { status: 201 });
}
async function PATCH6(req) {
  const { searchParams } = new URL(req.url);
  const id = searchParams.get("id");
  if (!id) return import_server26.NextResponse.json({ error: "id required" }, { status: 400 });
  const body = await req.json();
  ...
  return import_server26.NextResponse.json(updated);
}
...
async function GET23(req) {
  ...
  return import_server27.NextResponse.json(pricing);
}
async function POST19(req) {
  ...
  return import_server27.NextResponse.json(pricing, { status: 201 });
}
...
async function GET24(req) {
  ...
  return import_server28.NextResponse.json(deadlines);
}
async function POST20(req) {
  ...
  return import_server28.NextResponse.json(deadline, { status: 201 });
}
async function PATCH7(req) {
  const { searchParams } = new URL(req.url);
  const id = searchParams.get("id");
  if (!id) return import_server28.NextResponse.json({ error: "id required" }, { status: 400 });
  const body = await req.json();
  const allowedFields = {};
  ...
  return import_server28.NextResponse.json(updated);
}
...
async function POST21(req) {
  ...
  if (!cnj) {
    return import_server29.NextResponse.json({ error: "CNJ \xE9 obrigat\xF3rio" }, { status: 400 });
  }
  const info = extrairTribunalDoCNJ(cnj);
  if (!info) {
    return import_server29.NextResponse.json({
  ...
  try {
    ...
    return import_server29.NextResponse.json(resultado);
  } catch (error) {
...
async function POST22(req) {
  ...
  if (!processId) {
    return import_server30.NextResponse.json({ error: "processId \xE9 obrigat\xF3rio" }, { status: 400 });
  }
  const proc = await db.process.findUnique({
    where: { id: processId },
  ...
  if (!proc) {
    return import_server30.NextResponse.json({ error: "Processo n\xE3o encontrado" }, { status: 404 });
  }
  if (!proc.cnj) {
    return import_server30.NextResponse.json({
  ...
  if (usarDemo) {
    ...
    try {
      ...
      if (ehErroConexao) {
        ...
        return import_server30.NextResponse.json({ error: error.message }, { status: 500 });
      }
    }
  }
...
async function POST23(req) {
  ...
  if (!tema) {
    return import_server31.NextResponse.json({ error: "Tema \xE9 obrigat\xF3rio" }, { status: 400 });
  }
...
Responda em portugu\xEAs brasileiro, formato Markdown.`;
  try {
    ...
    return import_server31.NextResponse.json({
      tema,
      area,
      jurisprudencia,
      geradoEm: (/* @__PURE__ */ new Date()).toISOString(),
...
async function GET26(req) {
  ...
  if (!cep || cep.length !== 8) {
    return import_server32.NextResponse.json({ error: "CEP inv\xE1lido. Use 8 d\xEDgitos." }, { status: 400 });
  }
  try {
    ...
    const data = await res.json();
    if (data.erro) {
      return import_server32.NextResponse.json({ error: "CEP n\xE3o encontrado" }, { status: 404 });
    }
    return import_server32.NextResponse.json({
      cep: data.cep,
...
async function GET27() {
  ...
  return import_server33.NextResponse.json({
...
async function POST24(req) {
  ...
  if (!isAuthorized) {
    return import_server34.NextResponse.json({ error: "N\xE3o autorizado" }, { status: 401 });
  }
  ...
  if (processos.length === 0) {
    return import_server34.NextResponse.json({
      sincronizado: true,
...
async function POST25(req) {
  ...
  if (!searchText) {
    return import_server35.NextResponse.json({ error: "Texto de busca necess\xE1rio" }, { status: 400 });
  }
  ...
  return import_server35.NextResponse.json({
    found,
...
async function GET30() {
  ...
  return import_server36.NextResponse.json(logs);
}
...
async function GET31() {
  ...
  return import_server37.NextResponse.json(users);
}
async function POST26(req) {
  try {
      ...
      try {
        ...
        if (err.code === "auth/email-already-exists") {
          try {
            ...
            return import_server37.NextResponse.json({ error: `Erro ao obter usu\xE1rio existente no Firebase: ${getErr.message}` }, { status: 400 });
          }
          ...
          return import_server37.NextResponse.json({ error: `Erro ao criar usu\xE1rio no Firebase Auth: ${err.message}` }, { status: 400 });
        }
      }
    }
    ...
    return import_server37.NextResponse.json(user, { status: 201 });
  } catch (err) {
    console.error("Erro ao convidar usu\xE1rio (POST /api/team):", err);
    return import_server37.NextResponse.json({
...
async function PATCH8(req) {
  try {
    const { searchParams } = new URL(req.url);
    const id = searchParams.get("id");
    if (!id) return import_server37.NextResponse.json({ error: "id required" }, { status: 400 });
    const body = await req.json();
    ...
    return import_server37.NextResponse.json(updated);
  } catch (err) {
    console.error("Erro ao atualizar usu\xE1rio (PATCH /api/team):", err);
    return import_server37.NextResponse.json({ error: `Erro no servidor ao atualizar usu\xE1rio: ${err.message || err}` }, { status: 500 });
  }
}
async function DELETE2(req) {
  try {
    ...
    return import_server37.NextResponse.json({ ok: true });
  } catch (err) {
    console.error("Erro ao deletar usu\xE1rio (DELETE /api/team):", err);
    return import_server37.NextResponse.json({ error: `Erro no servidor ao deletar usu\xE1rio: ${err.message || err}` }, { status: 500 });
  }
}
...
async function GET32(req) {
  ...
  return import_server38.NextResponse.json(docs);
}
async function POST27(req) {
  ...
  return import_server38.NextResponse.json(doc3, { status: 201 });
}
...
async function POST28(req) {
  ...
  if (!user) {
    return import_server39.NextResponse.json({ error: "Credenciais inv\xE1lidas" }, { status: 401 });
  }
  if (password !== "demo123" && password !== "123456" && password !== user.password) {
    return import_server39.NextResponse.json({ error: "Senha incorreta" }, { status: 401 });
  }
  if (user.twoFactorEnabled && twoFactorCode !== "123456") {
    return import_server39.NextResponse.json({
      requires2FA: true,
...
function toNextRequest(req) {
  ...
  return new import_server40.NextRequest(url, init);
}
